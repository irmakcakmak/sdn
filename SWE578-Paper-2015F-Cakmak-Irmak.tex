...
and this is typically done by using a common protocol for (e.g. OpenFlow), providing programmability 
of different devices, along with interoperability of such devices in a heterogeneous networking environment.

OpenFlow, the open protocol for programming switches and routers exploits common 
denominator of device interfaces exposed. It provides set of methods for programming 
flow-table of devices. An OpenFlow switch has three pieces: flow table, secure channel, 
...
"drop packets belonging to a flow". Basic accounting of flows are also kept. 
